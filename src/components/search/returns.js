...
function RenderAvailableRouteComponents() {
    ...
    for (var i = 0; i < routes.length; i++) {
        html.push(constructHTMLSelection(routes[i]));
    }
...
function constructHTMLSelection(data) {
            ...
            <div class="row displayListRow">
                ...
                <div class="col-sm-2">
                    ...
                    <label class="radiobtn">
                        <input type="radio" name="travelType" value="economy" data-price={data.OnlineFares.Economy.FareTotal} data-farekey={data.OnlineFares.EconomyExtra.FareKey} /> </label>
                    <h5>${data.OnlineFares.Economy.FareTotal}</h5>
                </div>
                <div class="col-sm-2">
                <p>EconomyExtra</p>
                    <label class="radiobtn">
                        <input type="radio" name="travelType" value="economy-extra" data-scheduleNumber="600089" data-price={data.OnlineFares.EconomyExtra.FareTotal}
                            data-farekey={data.OnlineFares.EconomyExtra.FareKey} /></label>
                    <h5>${data.OnlineFares.EconomyExtra.FareTotal}</h5>
                </div>
                <div class="col-sm-2">
                <p>Flexible</p>
                    <label class="radiobtn"><input type="radio" name="travelType" value="flex" data-price={data.OnlineFares.Flexible.FareTotal} data-farekey={data.OnlineFares.Flexible.FareKey} /></label>
                    <h5>${data.OnlineFares.Flexible.FareTotal}</h5>

                </div>
            </div>
            <Button variant="primary" onClick={continueButton} type="button" class="continueButton hidden" data-schedulekey={data.ScheduleKey} data-arrivalLocationCode={data.ArrivalLocationCode}
