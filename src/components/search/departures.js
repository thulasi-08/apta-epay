...
function constructHTMLSelection(data, number) {
    ...
    return (
        <Card>
            ...
            <Card.Body>
                <Card.Title>{fromLocation} to {toLocation} </Card.Title>
                <div class="row displayListRow">
                    ...
                    <div class="col-sm-2">
                        <p>Flexible</p>
                        <label class="radiobtn"><input type="radio" name={radioName} value="flex" onClick={handleChange} data-price={data.OnlineFares.Flexible.FareTotal} data-farekey={data.OnlineFares.Flexible.FareKey} /></label>
                        <h5>${data.OnlineFares.Flexible.FareTotal}</h5>

                    </div>
                </div>
                <Button variant="primary" onClick={continueButton} data-radioname={radioName} data-price={data.OnlineFares.Economy.FareTotal} data-farekey={data.OnlineFares.EconomyExtra.FareKey} type="button" class="continueButton" data-schedulekey={data.ScheduleKey} data-arrivalLocationCode={data.ArrivalLocationCode}
